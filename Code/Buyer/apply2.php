...
<nav class="navbar navbar-expand-lg bg-light">
  ...
  ?>
<section>
  <form action="count.php?ids=<?php echo $ids; ?>">
  <div class="m-4">
  <div style="font-size: 25px ;">
<h2 style="margin-bottom:20px;">Select items :</h2>
        <select title="Can't Change values" name="up" id="upd" disabled>
  ...
  <br>
   ...
   <div>
    <p style="margin-top:10px; margin-bottom: 0px;"><h2>Apply Again</h2></p>
    <div>
      <input title="Can't Change values" type="text" name="uprice" style="margin: 0px 4px 4px 0px; height:50px; width:300px " value="<?php echo $data['Price Per Item']; ?>"  pattern = "\d+" placeholder= "enter price per item" maxlength="10" readonly>
    </div>
    <div>
      <input title="Can't Change values" type="number" style="margin: 20px 4px 4px 0px; height:50px; width:300px"  name="uquan" value="<?php echo $data['Quantity']; ?>" placeholder= "Quantity" readonly><br> 
    </div> 
    <div class="m-4" >
